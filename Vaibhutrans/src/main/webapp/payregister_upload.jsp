...
<head>
    <meta charset="UTF-8">
    <title>Upload Pay Register - Vaibhutrans</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="page-content-wrapper">
        <div class="upload-card">
            <h3><i class="fa fa-file-invoice-dollar text-indigo me-2"></i> Upload Pay Register</h3>
            <p class="text-muted text-center small mb-4">Select cluster, month, year, and upload Excel spreadsheet</p>
            ...
            <form action="pay-register" method="post" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="uploadCluster"><i class="fa fa-layer-group me-1"></i> Cluster</label>
                </div>
                ...
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        <div class="form-floating">
                            ...
                            <label for="uploadMonth"><i class="fa fa-calendar-alt me-1"></i> Month</label>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-floating">
                            ...
                            <label for="uploadYear"><i class="fa fa-calendar me-1"></i> Year</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="file-drop-area mb-3" onclick="document.getElementById('fileInput').click();">
                    ...
                    <p class="mb-1 fw-bold text-dark small">Click or drag Pay Register Excel here</p>
                    <span class="text-muted small">Supports .xlsx or .xls files</span>
                    <input type="file" id="fileInput" name="excelFile" accept=".xlsx,.xls" class="d-none" onchange="showFileName(this)" required>
                    <div id="fileNameDisplay" class="mt-2 text-indigo fw-bold small"></div>
                </div>

                <button type="submit" class="btn btn-upload">
                    <i class="fa fa-cogs me-1"></i> Process & Save Pay Register
                </button>
            </form>
        </div>
    </div>
