...
<html>
<head>
    <title>Upload HR Statement - Vaibhutrans</title>
...
<body>
    ...
    <div class="page-content-wrapper">
        <div class="upload-card">
            <h3><i class="fa fa-file-excel text-primary"></i> Upload Transaction Excel</h3>

            <% if (request.getAttribute("message") != null) { %>
                <div class="alert alert-success py-2 mb-3" role="alert">
                    <i class="fa fa-check-circle"></i> <%= request.getAttribute("message") %>
                </div>
            <% } %>
            ...
            <form action="uploadExcel" method="post" enctype="multipart/form-data">
                <div class="file-drop-area" onclick="document.getElementById('fileInput').click();">
                    ...
                    <p class="mb-1 fw-bold text-secondary">Click or drag Excel file here</p>
                ...
                <button type="submit" class="btn btn-upload">
                    <i class="fa fa-cogs"></i> Upload & Process
                </button>
            </form>
            
            <div class="text-center mt-3">
                <!-- <a href="dashboard.jsp" class="text-decoration-none text-muted small"><i class="fa fa-arrow-left"></i> Back to Dashboard</a> -->
            </div>
        </div>
    </div>
